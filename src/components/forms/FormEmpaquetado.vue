...
const { coordinador, incidencias } = toRefs(props.modelValue);
</script>

<template>
  <div>
    <label class="block text-gray-700 text-sm font-bold mb-2">COORDINADOR:</label>
    <input type="text" v-model="coordinador" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" />
